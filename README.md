**2025 Szanto lab data coordinator challenge.**

**Code:**  
Hayes_data_challenge.R  
Hayes_data_challenge_report.rmd  
  - Only Hayes_data_challenge.R needs to be run directly; it is a parent script that generates the rmarkdown report.  
